...
huxreg("ISS" = lmiss, "SINGOOS" = lmsingoos, "MULTOOS" = lmmultoos, "DAYS MISSED" = lmdays, number_format = 5, ci_level = .95, error_format = "({conf.low} -- {conf.high})", bold_signif = 0.05)
